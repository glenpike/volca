...
export default KORG_MIDI_NOTES
...
export const midiToNote = (noteNumber: number) => KORG_MIDI_NOTES[noteNumber]
export const noteToMidi = (note: string) => KORG_MIDI_NOTES.indexOf(note)